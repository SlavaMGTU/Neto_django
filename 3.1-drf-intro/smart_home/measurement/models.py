...
#     id_sensor = models.ManyToManyField(Sensor, through='Tag', related_name= 'scopes', verbose_name='ID датчика')
#     temperature = models.CommaSeparatedIntegerField(verbose_name='Температура при измерении')
